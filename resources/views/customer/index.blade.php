	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="{{ url('customers/create') }}" class="btn btn-sm btn-outline-primary float-right" data-toggle="modal" data-target="#modal" id="btn-create-customer"><i class="fas fa-plus"></i> Create new customer</a>
			</div>
			<div class="card-body">
...
<script>
	$(document).ready(function () {
		...
		$("#btn-create-customer").click(function (e) {
			e.preventDefault();
		...
		$("body").on("click", ".btn-show", function (e) {
			...
			$.ajax({
				...
				dataType: "html",
				success: function (response) {
					$("#modal-title").text("About customer");
					$("#modal-body").html(response);
					$("#btn-submit").hide();
					$("#modal").modal("show");
				},
		...
		$("body").on("click", ".btn-edit", function (e) {
			...
			$.ajax({
				...
				dataType: "html",
				success: function (response) {
					$("#modal-title").text("Change customer data");
					$("#modal-body").html(response);
		...
		$("body").on("click", ".btn-buy", function (e) {
			...
			$.ajax({
				url: "{{ url('inventories/datatables') }}",
				method: "GET",
				dataType: "json",
				success: function (response) {
					var data = {};
