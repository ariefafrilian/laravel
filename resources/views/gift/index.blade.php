	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="{{ url('gifts/create') }}" class="btn btn-sm btn-outline-primary float-right" data-toggle="modal" data-target="#modal" id="btn-create-gift"><i class="fas fa-plus"></i> Create new gift</a>
			</div>
			<div class="card-body">
...
<script>
	$(document).ready(function () {
		...
		$("#btn-create-gift").click(function (e) {
			e.preventDefault();
			...
			$.ajax({
    			...
    			success: function (response) {
    				$("#modal-title").text("Create new gift");
		...
		$("body").on("click", ".btn-edit", function (e) {
			...
			$.ajax({
				...
				dataType: "html",
				success: function (response) {
					$("#modal-title").text("Change gift data");
					$("#modal-body").html(response);
